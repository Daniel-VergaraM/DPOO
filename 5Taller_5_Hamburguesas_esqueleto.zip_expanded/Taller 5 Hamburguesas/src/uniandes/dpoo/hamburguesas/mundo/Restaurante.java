...
public class Restaurante {
	...
	/**
	 * El pedido en curso. Cuando no hay un pedido en cuerso, este atributo será
	 * null.
	 */
	 ...
	 * @throws YaHayUnPedidoEnCursoException Se lanza esta excepción si ya había un
	 *                                       pedido en curso cuando se llamó a este
	 *                                       método
	 */
	...
	/**
	 * Este método cierra un pedido, creando la factura y guardándolo en el
	 * histórico de pedidos.
	 *
	 * La factura queda guardada en un archivo cuyo nombre debe ser
	 * PREFIJO_FACTURAS, seguido del identificador del pedido, y debe tener
	 * extensión 'txt'. El archivo debe quedar en la carpeta CARPETA_FACTURAS.
	 *
	 * @throws NoHayPedidoEnCursoException Lanza esta excepción si no hay un pedido
	 *                                     en curso
	 * @throws FileNotFoundException       Lanza esta excepción si hay problemas
	...
	/**
	 * Retorna el pedido actual en curso. Si no hay un pedido en curso, retorna
	 * null.
	 *
	...
	/**
	 * Carga la información de los ingredientes, los productos y los combos del
	 * restaurante
	 *
	 * @param archivoIngredientes El archivo que tiene la información de los
	 *                            ingredientes
	 * @param archivoMenu         El archivo que tiene la información de los
	 *                            productos base
	...
	private void cargarCombos(File archivoCombos)
			throws ProductoRepetidoException, ProductoFaltanteException, IOException {
