...
public class Pedido {
	 ...
	 *
	 * Al crear un nuevo pedido se le debe asignar como identificador el número de
	 * pedido, y se debe incrementar el valor del atributo estático 'numeroPedidos'
	 *
	 * @param nombreCliente
	 ...
	 */
	public boolean agregarProducto(Producto nuevoProducto) throws NullPointerException {
	...
	/**
	 * Retorna el precio total del pedido, basado en el valor de cada uno de los
	 * productos y en el IVA
	 *
	 * @return La sumatoria de los precios de los productos con el valor adicional
	 *         del IVA
	 */
	...
	/**
	 * Retorna una cadena con toda la información que debe quedar en el factura. La
	 * información incluye:
	 *
	 ...
	 * @throws FileNotFoundException Se lanza esta excepción si no se puede crear el
	 *                               archivo para guardar la factura
	 */
