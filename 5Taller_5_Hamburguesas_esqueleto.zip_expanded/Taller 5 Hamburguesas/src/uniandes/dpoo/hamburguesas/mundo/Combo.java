...
public class Combo implements Producto {
	...
	/**
	 * El descuento que incluye el combo. Es un número entre 0 y 1, donde 0
	 * corresponde a que no hay descuento y 1 corresponde al 100% de descuento
	 */
	 ...
	 * @param descuento El descuento sobre el valor normal de los productos en el
	 *                  combo
	 ...
	 *
	 * El precio está basado en aplicarle el descuento del combo al valor de cada
