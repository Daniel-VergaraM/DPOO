...
/**
 * Esta excepción se usa para indicar que había un pedido en curso cuando se
 * intentó crear un nuevo pedido
 */
...
public class YaHayUnPedidoEnCursoException extends HamburguesaException {
	...
	/**
	 * El nombre del nuevo cliente para el cual se está intentando crear un nuevo
	 * pedido
	 */
	...
	public String getMessage() {
		return "Ya existe un pedido en curso, para el cliente " + nombreCliente
				+ " así que no se puede crear un pedido para " + nombreNuevoCliente;
	}
}
